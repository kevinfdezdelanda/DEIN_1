		...
		if(error.equals("")) {
			...
			if(id!=null) {
				...
				try {
					...
					JasperReport report = (JasperReport) JRLoader.loadObject(getClass().getResource("/informes/ultimoPrestamo.jasper"));
					JasperPrint jprint = JasperFillManager.fillReport(report, map, con.getConexion());
