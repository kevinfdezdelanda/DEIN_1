...
public class V_Olimpiadas extends JFrame {
	...
	public V_Olimpiadas() {
		...
		gbc_listaEvento.insets = new Insets(0, 0, 5, 5);
		gbc_listaEvento.fill = GridBagConstraints.BOTH;
		gbc_listaEvento.gridx = 0;
		gbc_listaEvento.gridy = 1;
		panel_1.add(listaEvento, gbc_listaEvento);
